SET JAVA_HOME=D:\Java\j2sdk1.4.2_19
SET PATH=D:\Java\j2sdk1.4.2_19\bin;%PATH%
java -version

SET MAVEN_HOME=E:\ToolDeveloperJava\LibreriasJava\maven
SET PATH=E:\ToolDeveloperJava\LibreriasJava\maven\bin;%PATH%
