...
public class FormatoFacturaPublicoImpl implements FormatoFactura {

	private static Log iObjLog = LogFactory.getLog(FormatoFacturaPublicoImpl.class);

	private int cMarca = 1;
	
	public FormatoFacturaPublicoImpl(int cMarca) {
		this.cMarca = cMarca;
	}
	...
	public FacturaElectronicaBean crearFacturaFormato(FacturaElectronicaBean objFacturaBean) throws Exception {
		...
		try {					
			...
			OrdenBean objOrdenBean = objBuscarOrdenDAO.buscarOrdenExamenFac20(Integer.parseInt(objFacturaBean.getkOrdenSucursal()));			
