...
public class FormatoFacturaSinDescuentoSinonimosImpl implements FormatoFactura {

	private static Log iObjLog = LogFactory.getLog(FormatoFacturaSinDescuentoSinonimosImpl.class);

	private int cMarca = 1;
	
	public FormatoFacturaSinDescuentoSinonimosImpl(int cMarca) {
		this.cMarca = cMarca;
	}
	...
	public FacturaElectronicaBean crearFacturaFormato(FacturaElectronicaBean objFacturaBean) throws Exception {
		...
		try {					
			...
			objFacturaBean.setMdescuento(0.0);
...
//					iObjLog.debug("Consulta OrdenDatosFacturacionDao.SearchOrdenNuevaViaje:...Monto a Faturar  " + objOrdenExamenBean.getMfacturaempresa());
					objBody.setDblImporte((objOrdenExamenBean.getMfacturaempresa()) / 1.16);
//					iObjLog.debug("Consulta OrdenDatosFacturacionDao.SearchOrdenNuevaViaje:...Monto a Faturar 2 " + objBody.getDblImporte());
				}					
