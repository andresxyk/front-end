...
<html lang="en" class="no-js">
	...
	<input type="hidden" id="cMarca" name="cMarca" value=<%=cMarca %> >	
	...
	<div class="container">
			...
			<div class="row column">
				<div class="datosFiscales">
					...
					<div class="datosFiscales back">				
						<%
							if (objOrdenBean.getUanoorden() < objOrdenBean.getUanoactual()) {
								out.println("<label><p><strong>MENSAJE, Factura anterior " + objOrdenBean.getStrFactura().trim() + "</strong></p></label>");
								out.println("<p>.</p>"); 
								out.println("<label><p><strong>Esta orden no se puede facturar, ya que es del año pasado</strong></p></label>");
								if (cMarca == 1) {
									out.println("<p>Puedes reimprir el <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Olab/PDF/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".pdf'))><img src='/web2labportal/images/icoPdf.png' alt='Factura PDF'></a> y <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Olab/XML/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".xml'))><img src='/web2labportal/images/icoXml.png' alt='Factura XML'></a></p>");
								} else if (cMarca == 4) {
									out.println("<p>Puedes reimprir el <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Azteca/PDF/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".pdf'))><img src='/web2labportal/images/icoPdf.png' alt='Factura PDF'></a> y <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Azteca/XML/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".xml'))><img src='/web2labportal/images/icoXml.png' alt='Factura XML'></a></p>");
								}
								...
								out.println("<p>.</p>");
								out.println("<p>.</p>");
							} else if (objOrdenBean.getSmensajeerror().trim().length() > 4) {
								...
								out.println("<p>.</p>");
								out.println("<p>.</p>");
							} else if ((objOrdenBean.getNofacturas() >= 20) && (objOrdenBean.getStrFactura().trim().length() > 1)) {
								out.println("<label><p><strong>MENSAJE, Factura anterior " + objOrdenBean.getStrFactura().trim() + "</strong></p></label>");
								out.println("<p>.</p>"); 
								out.println("<label><p><strong>Esta orden no se puede facturar, ya tiene 3 facturas anteriores</strong></p></label>");
								if (cMarca == 1) {								
									out.println("<p>Puedes reimprir el <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Olab/PDF/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".pdf'))><img src='/web2labportal/images/icoPdf.png' alt='Factura PDF'></a> y <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Olab/XML/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".xml'))><img src='/web2labportal/images/icoXml.png' alt='Factura XML'></a></p>");
								} else if (cMarca == 4) {
									out.println("<p>Puedes reimprir el <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Azteca/PDF/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".pdf'))><img src='/web2labportal/images/icoPdf.png' alt='Factura PDF'></a> y <a href=javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Azteca/XML/FacturacionElectronica_" + objOrdenBean.getStrFactura().trim() + ".xml'))><img src='/web2labportal/images/icoXml.png' alt='Factura XML'></a></p>");
								...
								out.println("<p>.</p>");
								out.println("<p>.</p>");
							} else if (objOrdenBean.getNofacturas() >= 20) {
								out.println("<label><p><strong>MENSAJE</strong></p></label>");
								out.println("<p>.</p>"); 
								out.println("<label><p><strong>Esta orden no se puede facturar, ya tiene 3 facturas anteriores</strong></p></label>");
								out.println("<p>.</p>");
				...
				<div class="bigBtns">
						<%
							if(objOrdenBean.getMpagapaciente() > 0) {				
								if (((objOrdenBean.getNofacturas() >= 4) && (objOrdenBean.getStrFactura().trim().length() > 1)) || (objOrdenBean.getSmensajeerror().trim().length() == 4)) {
									
								} else 	if (objOrdenBean.getUanoorden() < objOrdenBean.getUanoactual()) {
        ...
        <div id="modal2">
            ...
            <div class="content">
                ...
                <p class='msg'>ESTIMADO PACIENTE, EN CASO DE HABER INGRESADO SUS DATOS FISCALES ERR&oacute;NEAMENTE, USTED TIENE HASTA EL 31 DE DICIEMBRE DEL 2016 PARA REALIZAR 2 RE FACTURACIONES.</p>
...
<!--            <p class='reMsg'>ESTIMADO PACIENTE LE PEDIMOS VERIFICAR NUEVAMENTE SUS DATOS FISCALES YA QUE NO PODR&aacute; MODIFICARSE LA FACTURA GENERADA</p>   --> 
                <p class='reMsg'>ESTIMADO PACIENTE, EN CASO DE HABER INGRESADO SUS DATOS FISCALES ERR&oacute;NEAMENTE, USTED TIENE HASTA EL 31 DE DICIEMBRE DEL 2016 PARA REALIZAR 2 RE FACTURACIONES.</p>    
