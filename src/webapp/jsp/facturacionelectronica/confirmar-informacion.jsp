	...
	<div class="container">
        ...
        <div id="modal2">
            ...
            <div class="content">
                ...
                <p class='msg'>ESTIMADO PACIENTE, EN CASO DE HABER INGRESADO SUS DATOS FISCALES ERRÓNEAMENTE, USTED TIENE HASTA EL 31 DE DICIEMBRE DEL 2016 PARA REALIZAR 2 RE FACTURACIONES.</p>
...
<!--            <p class='reMsg'>ESTIMADO PACIENTE LE PEDIMOS VERIFICAR NUEVAMENTE SUS DATOS FISCALES YA QUE NO PODRÁ MODIFICARSE LA FACTURA GENERADA</p>   --> 
                <p class='reMsg'>ESTIMADO PACIENTE, EN CASO DE HABER INGRESADO SUS DATOS FISCALES ERRÓNEAMENTE, USTED TIENE HASTA EL 31 DE DICIEMBRE DEL 2016 PARA REALIZAR 2 RE FACTURACIONES.</p>    
