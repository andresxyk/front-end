...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="/web2labportal/css/consultaresultados/paso-1.css?238982119" id="pagesheet"/>  
  <!-- Other scripts -->
 ...
 <body>
   ...
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pu7618"><!-- group -->
     <div class="gradient rounded-corners clearfix grpelem" id="u7618"><!-- group -->
      <div class="clearfix grpelem" id="pu7630"><!-- column -->
       <div class="colelem" id="u7630"><!-- image -->
        <img class="block" id="u7630_img" src="/web2labportal/images/consultaresultados/logo%20olab.png" alt="" width="154" height="83"/>
       </div>
       <div class="rounded-corners colelem" id="u7455"><!-- simple frame --></div>
      </div>
      <div class="clearfix grpelem" id="pu7619"><!-- column -->
       <div class="clearfix colelem" id="u7619"><!-- group -->
        <div class="clearfix grpelem" id="u7402-4"><!-- content -->
         <p>Consulta de Resultados</p>
        </div>
       </div>
       <div class="rgba-background rounded-corners clearfix colelem" id="u7493"><!-- group -->
...
<!-- <form class="form-grp clearfix grpelem" id="widgetu7930" method="post" enctype="multipart/form-data" action="confirmar-informacion.jsp" onSubmit="envioFinal();" onSubmit="alert('Este formulario HTML est&aacute;ndar est&aacute; configurado para que funcione con Adobe Business Catalyst.');"><!-- group -->
   <form class="form-grp clearfix grpelem" id="widgetu7930"  method="post" enctype="multipart/form-data" action="confirmar-informacion.jsp" onSubmit="envioFinal();" ><!-- group -->
      ...
      <div class="fld-grp clearfix grpelem" id="widgetu7947" data-required="true"><!-- group -->
       ...
       <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u7948-3"><!-- content --><input class="wrapped-input" type="text" spellcheck="false" id="widgetu7947_input" name="widgetu7947_input" value="<%=skOrdenSucursal%>" tabindex="1"/></span>
      </div>
...
<!--   <img class="grpelem" src="/web2labportal/images/consultaresultados/captcha.png" alt="Imagen de marcador de posici&oacute;n de CAPTCHA" title="Esta imagen es un marcador de posici&oacute;n para una imagen CAPTCHA. Si publica el sitio con Adobe Business Catalyst, esta imagen ser&aacute; reemplazada por una imagen CAPTCHA generada por el servidor." id="u7983"/><!-- captcha placeholder -->
      </div>
     </form>
     <div class="grpelem" id="u8081"><!-- image -->
      <img class="block" id="u8081_img" src="/web2labportal/images/consultaresultados/dro1.png" alt="" width="471" height="300"/>
     </div>
     <a class="nonblock nontext rgba-background rounded-corners clearfix grpelem" id="u7145"  href="javascript:envioPasos('paso-2.jsp');"><!-- group --><div class="clearfix grpelem" id="u7144-4"><!-- content --><p>Continuar</p></div></a>
    </div>
