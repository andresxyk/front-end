...
<!-- <form class="form-grp clearfix grpelem" id="widgetu7930" method="post" enctype="multipart/form-data" action="confirmar-informacion.jsp" onSubmit="envioFinal();" onSubmit="alert('Este formulario HTML estándar está configurado para que funcione con Adobe Business Catalyst.');"><!-- group -->
...
<!--   <img class="grpelem" src="/web2labportal/images/consultaresultados/captcha.png" alt="Imagen de marcador de posición de CAPTCHA" title="Esta imagen es un marcador de posición para una imagen CAPTCHA. Si publica el sitio con Adobe Business Catalyst, esta imagen será reemplazada por una imagen CAPTCHA generada por el servidor." id="u7983"/><!-- captcha placeholder -->
      </div>
     </form>
