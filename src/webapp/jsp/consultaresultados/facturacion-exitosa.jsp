...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="/web2labportal/css/consultaresultados/facturacion-exitosa.css?363365112" id="pagesheet"/>
  <!-- Other scripts -->
 ...
 <body>
   <% 
   	  String sURLconsultaresultados = request.getParameter("urlFactura"); 
   %>
     ...
     <div class="position_content" id="u8066_position_content">
      ...
      <div class="clearfix colelem" id="pu8044"><!-- group -->
       <div class="grpelem" id="u8044"><!-- image -->
        <img class="block" id="u8044_img" src="/web2labportal/images/consultaresultados/dro5.png" alt="" width="144" height="180"/>
       </div>
       <div class="clearfix grpelem" id="pu8126"><!-- column -->
        <div class="rgba-background rounded-corners clearfix colelem" id="u8126"><!-- group -->
         <div class="grpelem" id="u8121"><!-- image -->
          <img class="block" id="u8121_img" src="/web2labportal/images/consultaresultados/factura.jpg" alt="" width="338" height="439"/>
         </div>
        </div>
<!--          <a class="nonblock nontext rgba-background rounded-corners clearfix colelem" id="u8049" href="index.html"> group --><div class="clearfix grpelem" id="u8051-4"><!-- content <p>Recibir por correo</p> --></div></a>
       </div>
       <a class="nonblock nontext rgba-background rounded-corners clearfix grpelem" id="u8050" href=<%=sURLconsultaresultados%>> <!-- group --><div class="clearfix grpelem" id="u8052-4"><!-- content --><p>Descargar</p></div></a>
      </div>
     </div>
    </div>
  ...
  <scriptsrc="/web2labportal/javascript/consultaresultados/jquery.tobrowserwidth.js?4052033419" type="text/javascript"></script>
  <!-- Other scripts -->
  <script type="text/javascript">
