...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="/web2labportal/css/consultaresultados/paso-4.css?4056432042" id="pagesheet"/>
  <!-- Other scripts -->
...
<!--   <img class="grpelem" src="/web2labportal/images/consultaresultados/captcha4.png" alt="Imagen de marcador de posici&oacute;n de CAPTCHA" title="Esta imagen es un marcador de posici&oacute;n para una imagen CAPTCHA. Si publica el sitio con Adobe Business Catalyst, esta imagen ser&aacute; reemplazada por una imagen CAPTCHA generada por el servidor." id="u7983"/><!-- captcha placeholder -->
      </div>
     </form>
     <div class="grpelem" id="u7506"><!-- image -->
      <img class="block" id="u7506_img" src="/web2labportal/images/consultaresultados/dro4.png" alt="" width="441" height="238"/>
     </div>
     <a class="nonblock nontext rgba-background rounded-corners clearfix grpelem" id="u8096" href="javascript:envioPasos('paso-3.jsp');"><!-- group --><div class="clearfix grpelem" id="u8098-4"><!-- content --><p>Regresar</p></div></a>
     <div class="rounded-corners grpelem" id="u8118"><!-- simple frame --></div>
     <div class="rounded-corners grpelem" id="u8119"><!-- simple frame --></div>
    </div>
