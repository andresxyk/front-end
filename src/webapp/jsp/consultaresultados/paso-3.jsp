...
<!--   <img class="grpelem" src="/web2labportal/images/consultaresultados/captcha3.png" alt="Imagen de marcador de posici&oacute;n de CAPTCHA" title="Esta imagen es un marcador de posici&oacute;n para una imagen CAPTCHA. Si publica el sitio con Adobe Business Catalyst, esta imagen ser&aacute; reemplazada por una imagen CAPTCHA generada por el servidor." id="u7983"/><!-- captcha placeholder -->
      </div>
     </form>
