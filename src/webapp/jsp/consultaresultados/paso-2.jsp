...
<html>
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="/web2labportal/css/consultaresultados/paso-2.css?3923449416" id="pagesheet"/>
  <!-- Other scripts -->
     ...
     <div class="gradient rounded-corners clearfix grpelem" id="u7618"><!-- column -->
      <div class="position_content" id="u7618_position_content">
       ...
       <div class="clearfix colelem" id="pu8086"><!-- group -->
        <a class="nonblock nontext rgba-background rounded-corners clearfix grpelem" id="u8086" href="javascript:envioPasos('paso-1.jsp');"><!-- group --><div class="clearfix grpelem" id="u8088-4"><!-- content --><p>Regresar</p></div></a>
        <a class="nonblock nontext rgba-background rounded-corners clearfix grpelem" id="u8087" href="javascript:envioPasos('paso-3.jsp');"><!-- group --><div class="clearfix grpelem" id="u8089-4"><!-- content --><p>Continuar</p></div></a>
       </div>
...
<!--   <form class="form-grp clearfix grpelem" id="widgetu7930" method="post" enctype="multipart/form-data" action="confirmar-informacion.jsp" onSubmit="return true;"><!-- group -->
...
<!--   <img class="grpelem" src="/web2labportal/images/consultaresultados/captcha2.png" alt="Imagen de marcador de posici&oacute;n de CAPTCHA" title="Esta imagen es un marcador de posici&oacute;n para una imagen CAPTCHA. Si publica el sitio con Adobe Business Catalyst, esta imagen ser&aacute; reemplazada por una imagen CAPTCHA generada por el servidor." id="u7983"/><!-- captcha placeholder -->
     ...
     <div class="grpelem" id="u8076"><!-- image -->
      <img class="block" id="u8076_img" src="/web2labportal/images/consultaresultados/dro2.png" alt="" width="295" height="221"/>
     </div>
    </div>
