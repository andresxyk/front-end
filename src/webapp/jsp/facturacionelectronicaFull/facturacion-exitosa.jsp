    ...
    <div class="container">
       ...
       <img src="/web2labportal/images/facturacionelectronica2015/olab_logo.png" height= "80px" alt="" class="logo" />
        ...
        <div class="main clearfix">
        	<div class="center" >
        		<a id='btnaceptarPDF' href="javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Olab/PDF/FacturacionElectronica_<%=sURLFacturacionElectronica%>.pdf'))" >
	            ...
	            <br>
	            <br>
        		<a id='btnaceptarXML' href="javascript:void(window.open('http://192.237.150.66:9085/FacturasElectronicas_Olab/XML/FacturacionElectronica_<%=sURLFacturacionElectronica%>.xml'))" >
	                <button type="submit" id="notification-trigger" class="progress-button fileButton">
