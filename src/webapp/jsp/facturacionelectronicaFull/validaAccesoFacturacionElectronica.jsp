...
<%
	...
	response.sendRedirect("/web2labportal/jsp/facturacionelectronicaFull/confirmar-informacion.jsp?kordensucursalfinal=" + skOrdenSucursal +"&emailfinal=" + sEmail + "&passwordfinal=" + sPassword + "&datofiscalfinal=0");    	
%>
</html>