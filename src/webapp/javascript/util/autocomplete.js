...
/**
 * Funcion utilizada para inicializar un objeto autocompleter
 */
function createAutoCompleter(oTextId, oDivId, oFunction) {
     new Autocompleter.DWR(oTextId, oDivId, oFunction, {});
}

/**
 * Funcion utilizada para inicializar un objeto autocompleter
 */
//function _createAutoCompleter() {
//     new Autocompleter.DWR("numcarga", "suggest_carga", populateAutocomplete, {});
//}

Autocompleter.DWR = Class.create();
Autocompleter.DWR.prototype = Object.extend(new Autocompleter.Base(), 
	{initialize: 
		function(element, update, populator, options) {
