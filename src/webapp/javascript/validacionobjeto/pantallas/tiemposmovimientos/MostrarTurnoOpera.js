...
//			if (Audio) {
/*			
                var aud = new Audio("siguienteTurno.wav");
                if (aud) {
                    aud.addEventListener("load", function(e) {
                        if (e && e.target) {
                            //e.target.loop(45); (.loop may be changed to something like .loopcount in the future.)
                            e.target.play();
                        }
                    }, false);
                }
