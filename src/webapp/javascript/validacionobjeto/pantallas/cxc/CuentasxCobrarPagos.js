	...
	function reimprimirFacturaPDF() {
		...
		if(selectedMarca==1){
			strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Olab/PDF/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".pdf";
			abrirVentanaOrden(strRuta,snombre);	   			     			    
		    return true;
       	} else if(selectedMarca==4){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Azteca/XMLTMP/PDF/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".pdf";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true;
       	}else if(selectedMarca==5){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Swisslab/XMLTMP/PDF/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".pdf";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true;
       	}else if(selectedMarca==7){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Jenner/Prado/XMLTMP/PDF/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".pdf";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true;
       	}else if(selectedMarca==8){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Jenner/Lean/XMLTMP/PDF/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".pdf";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true;
	...
	function reimprimirFacturaXML() {
		...
		if(selectedMarca==1){
			strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Olab/XML/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".xml";
			abrirVentanaOrden(strRuta,snombre);	   			     			    
		    return true;
       	} else if(selectedMarca==4){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Azteca/XML/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".xml";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true;
       	}else if(selectedMarca==5){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Swisslab/XML/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".xml";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true;
       	}else if(selectedMarca==7){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Jenner/Prado/XML/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".xml";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true;
       	}else if(selectedMarca==8){
       		strRuta = "http://40.84.228.70:9085/FacturasElectronicas_Jenner/Lean/XML/FacturacionElectronica_" + frmPantalla.txtNumeroFactura.value + ".xml";
       		abrirVentanaOrden(strRuta,snombre);	   			     			    
    	    return true; 
       	}else if (selectedMarca==9){
       		var kfactura = frmPantalla.txtkFactura.value;
	...
	function pagoFactura_CallBack(data) { 
		...
		if((data.smensaje=="Exito en el registro del Pago") && (checkbox)){
			window.open("http://40.84.228.70:8192/facturas/complemento-pagos/"+data.keypago, "_blank");
		}
	}	
