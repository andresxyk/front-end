	...
	function init() {
		...
		BusquedaFacturas.buscarFacturaSustitucion(window.document.frmSustitucion.ufoliofactura.value,window.document.frmSustitucion.cmarca.value,window.document.frmSustitucion.tipofactura.value,buscarFacturaSustitucion_CallBack);
