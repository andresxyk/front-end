...
plupload.addI18n({
   ...
   'N/A' : 'N/D',
   'Drag files here.' : 'Arraste os arquivos pra c&aacute;',
   ...
   'Generic error.': 'Erro gen&eacute;rico.',
   'IO error.': 'Erro de E/S.',
   'File: %s': 'Arquivo: %s',
   'Close': 'Fechar',
   '%d files queued': '%d arquivo(s)',
   'Using runtime: ': 'Usando: ',
   'File: %f, size: %s, max file size: %m': 'Arquivo: %f, tamanho: %s, m&aacute;ximo: %m',
   ...
   'Upload URL might be wrong or doesn\'t exist': 'URL de envio est&aacute; errada ou não existe',
