...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.ca = {
		...
		messages   : {
			...
			'errJqui'              : 'La configuraci&oacute; de jQuery UI no &eacute;s vàlida. S\'han d\'incloure els components "selectable", "draggable" i "droppable".',
			'errNode'              : 'elFinder necessita crear elements DOM.',
			'errURL'               : 'La configuraci&oacute; de l\'elFinder no &eacute;s vàlida! L\'opci&oacute; URL no està configurada.',
			'errAccess'            : 'Acc&eacute;s denegat.',
			'errConnect'           : 'No s\'ha pogut connectar amb el rerefons.',
			'errAbort'             : 'S\'ha interromput la connexi&oacute;.',
			'errTimeout'           : 'Temps de connexi&oacute; excedit.',
			'errNotFound'          : 'No s\'ha trobat el rerefons.',
			'errResponse'          : 'La resposta del rerefons no &eacute;s vàlida.',
			'errConf'              : 'La configuraci&oacute; del rerefons no &eacute;s vàlida.',
			'errJSON'              : 'No està instal·lat el mòdul JSON del PHP.',
			'errNoVolumes'         : 'No s\'han trobat volums llegibles.',
			'errCmdParams'         : 'Els paràmetres per l\'ordre "$1" no s&oacute;n vàlids.',
			'errDataNotJSON'       : 'Les dades no s&oacute;n JSON.',
			...
			'errNotFolder'         : 'L\'objecte no &eacute;s una carpeta.',
			'errNotFile'           : 'L\'objecte no &eacute;s un fitxer.',
			'errRead'              : 'No s\'ha pogut llegir "$1".',
			'errWrite'             : 'No s\'ha pogut escriure a "$1".',
			'errPerm'              : 'Perm&iacute;s denegat.',
			...
			'errInvName'           : 'El nom de fitxer no &eacute;s vàlid.',
			'errFolderNotFound'    : 'No s\'ha trobat la carpeta.',
			'errFileNotFound'      : 'No s\'ha trobat el fitxer.',
			'errTrgFolderNotFound' : 'No s\'ha trobat la carpeta de dest&iacute; "$1".',
			...
			'errNoArchive'         : 'El fitxer no &eacute;s un arxiu o &eacute;s un tipus no suportat.',
			'errCmdNoSupport'      : 'El rerefons no suporta aquesta ordre.',
			'errReplByChild'       : 'No es pot reemplaçar la carpeta “$1” per un element que cont&eacute;.',
			...
			'cmdhome'      : 'Inici',
			'cmdinfo'      : 'Obt&eacute; informaci&oacute;',
			...
			'cmdup'        : 'V&eacute;s al directori superior',
      ...
      'ntfloadimg'  : 'S\'està carregant la imatge',
			...
			/********************************** messages **********************************/
			'confirmReq'      : 'Es necessita confirmaci&oacute;',
			'confirmRm'       : 'Voleu suprimir els fitxers?<br />L\'acci&oacute; es podrà desfer!',
			...
			'ver'             : 'Versi&oacute;',
			'protocol'        : 'versi&oacute; de protocol',
			'homepage'        : 'Pàgina del projecte',
			'docs'            : 'Documentaci&oacute;',
			...
			'dropFiles'       : 'Arrossegueu els fitxers aqu&iacute;',
			'or'              : 'o',
			...
			'aspectRatio'     : 'Relaci&oacute; d\'aspecte',
			'scale'           : 'Escala',
			'width'           : 'Amplada',
			'height'          : 'Alçada',
      'mode'            : 'Mode',
      ...
      'crop'            : 'Retalla',
			...
			'kindMsPP'        : 'Presentaci&oacute; del Microsoft Powerpoint',
			'kindOO'          : 'Document de l\'Open Office',
			'kindAppFlash'    : 'Aplicaci&oacute; Flash',
			...
			'AudioPlaylist'   : 'Llista de reproducci&oacute; MP3',
			'kindVideo'       : 'Fitxer de v&iacute;deo',
			'kindVideoDV'     : 'Fitxer de v&iacute;deo DV',
			'kindVideoMPEG'   : 'Fitxer de v&iacute;deo MPEG',
			'kindVideoMPEG4'  : 'Fitxer de v&iacute;deo MPEG-4',
			'kindVideoAVI'    : 'Fitxer de v&iacute;deo AVI',
			'kindVideoMOV'    : 'Fitxer de v&iacute;deo Quick Time',
			'kindVideoWM'     : 'Fitxer de v&iacute;deo Windows Media',
			'kindVideoFlash'  : 'Fitxer de v&iacute;deo Flash',
			'kindVideoMKV'    : 'Fitxer de v&iacute;deo Matroska',
			'kindVideoOGG'    : 'Fitxer de v&iacute;deo Ogg'
		}
	}
}
