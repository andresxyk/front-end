...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.pt_BR = {
		...
		messages   : {
			...
			'errJqui'              : 'Configuração inv&aacute;lida do JQuery UI. Verifique os componentes selectable, draggable e droppable incluidos.',
			'errNode'              : 'elFinder requer um elemento DOM para ser criado.',
			'errURL'               : 'Configuração inv&aacute;lida do elFinder! Você deve setar a opção da URL.',
			...
			'errResponse'          : 'Resposta inv&aacute;lida do backend.',
			'errConf'              : 'Configuração inv&aacute;lida do backend.',
			'errJSON'              : 'M&oacute;dulo PHP JSON não est&aacute; instalado.',
			'errNoVolumes'         : 'Não existe nenhum volume leg&iacute;vel disponivel.',
			'errCmdParams'         : 'Parâmetro inv&aacute;lido para o comando "$1".',
			...
			'errNotFolder'         : 'Objeto não &eacute; uma pasta.',
			'errNotFile'           : 'Objeto não &eacute; um arquivo.',
			'errRead'              : 'Incapaz de ler "$1".',
			'errWrite'             : 'Incapaz de escrever em "$1".',
			'errPerm'              : 'Permissão negada.',
			'errLocked'            : '"$1" est&aacute; bloqueado e não pode ser renomeado, movido ou removido.',
			'errExists'            : 'O nome do arquivo "$1" j&aacute; existe neste local.',
			'errInvName'           : 'Nome do arquivo inv&aacute;lido.',
			...
			'errPopup'             : 'Navegador impediu abertura da janela popup, Para abrir o arquivo desabilite est&aacute;  opção no navegador.',
			...
			'errMaxSize'           : 'Os dados excedem o tamanho m&aacute;ximo permitido.',
			'errFileMaxSize'       : 'Arquivo excede o tamanho m&aacute;ximo permitido.',
			...
			'errNoArchive'         : 'Arquivo inv&aacute;lido ou &eacute; um tipo sem suporte.',
			...
			'cmdopen'      : 'Abrir',
			'cmdpaste'     : 'Colar',
			'cmdquicklook' : 'Pr&eacute;-vizualização',
			'cmdreload'    : 'Recarregar',
			'cmdrename'    : 'Renomear',
			'cmdrm'        : 'Deletar',
			'cmdsearch'    : 'Achar arquivos',
			'cmdup'        : 'Ir para o diret&oacute;rio pai',
			...
			'ntfmkdir'    : 'Criar diret&oacute;rio',
			...
			'facebook'        : 'Junte-se a n&oacute;s no Facebook',
			'team'            : 'Time',
			...
			'kindFolder'      : 'Pasta',
			'kindAlias'       : 'Alias',
			'kindAliasBroken' : 'Alias inv&aacute;lido',
			// applications
			'kindApp'         : 'Aplicação',
			...
			'kindAWK'         : 'AWK',
			'kindCSV'         : 'Valores separados por v&iacute;rgula',
