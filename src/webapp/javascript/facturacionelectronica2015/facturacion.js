...
$(document).ready(function(){
	...
	$('#facturaDatos').validationEngine('attach', {
		...
		onValidationComplete: function(form, status) {
			if ( status ) {
				...
				$('#estadoInfo').text($( "#estado option:selected" ).text());			
	...
	$('#modalAccept').click(function () {
		...
		altaDatosFiscales($('#rfc').val(),$('#direccion').val(),$('#delegacion').val(),$( "#estado option:selected" ).text(),$('#razonSocial').val(),$('#colonia').val(),$('#codigoPostal').val());
	});
