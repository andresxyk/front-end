...
function tooltips() {			
	...
	agregarFuncuncionSelect("cboIndicacionesPaciente");
	tooltipselect();
}

function agregarFuncuncionSelect(strNameSelect) {
	drop = document.getElementById(strNameSelect);
	drop.onchange = tooltipselect;
}

function tooltipselect() {
	drop = document.getElementById("cboIndicacionesPaciente");
